...
| portal.frontend.image.tag | string | `"2.10.0"` |  |
...
| portal.server.graphqlServer.genericEnv.HUB_BRANCH_NAME | string | `"v2.9.x"` |  |
...
| portal.server.graphqlServer.genericEnv.WORKFLOW_HELPER_IMAGE_VERSION | string | `"2.9.0"` |  |
...
| portal.server.graphqlServer.image.tag | string | `"2.10.0"` |  |
...
| portal.server.graphqlServer.imageEnv.EVENT_TRACKER_IMAGE | string | `"litmusportal-event-tracker:2.10.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_EXPORTER_IMAGE | string | `"chaos-exporter:2.9.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_OPERATOR_IMAGE | string | `"chaos-operator:2.9.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_RUNNER_IMAGE | string | `"chaos-runner:2.9.0"` |  |
| portal.server.graphqlServer.imageEnv.SUBSCRIBER_IMAGE | string | `"litmusportal-subscriber:2.10.0"` |  |
...
| upgradeAgent.controlPlane.image.tag | string | `"2.10.0"` |  |
